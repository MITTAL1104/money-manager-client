        ...
        <Dashboard activeMenu="Filters">
            <div className="my-5 mx-auto">
                ...
                <div className="card p-4 mb-4">
                    <div className="flex items-center jsutify-between mb-4">
                    ...
                    <form action="" className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        <div>
                            <label htmlFor="type" className="black text-sm font-medium mb-1">Type</label>
                        ...
                        <div className="sm:col-span-1 md:col-span-1 flex items-end">
                            ...
                            <button onClick={handleSearch} className="ml-2 mb-1 p-2 bg-purple-800 hover:bg-purple-800 text-white rounded flex items-center jsutify-center cursor-pointer">
                                <Search size={20}/>
                            </button>
                        </div>
                    </form>
                ...
                <div className="card p-4">
                    ...
                    {transactions.length===0 && !loading?(
                        <p className="text-gray-500">Select the filters and hit search button to filter the transactions</p>
                    ):""}
                    {loading ? (
